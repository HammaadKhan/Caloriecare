        ...
        <div class="container">
            <header class="mx-auto mb-16 max-w-lg text-center">
                ...
                <div class="inline-flex items-center">
                    ...
                    <div class="text-left">
                        <span
                            class="text-2xs font-medium tracking-tight text-jacarta-700 dark:text-jacarta-200"><?= $admin['name']?> </span>
            ...
            <!-- Featured image -->
            <figure class="mb-16">
                <img src="./assets/front/img/blog/<?=$blogs['image'] ?>" alt="post 1"
            ...
            <div class="mx-auto max-w-[48.125rem]">
                ...
                <div
                    ...
                    <div>
                        <span
                            class="mb-3 mt-2 block font-display text-base text-jacarta-700 dark:text-white"><?= $admin['name']?> </span>
